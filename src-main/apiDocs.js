...
const API_DOCS = [
  ...
  { name: 'getLicenseStatus', category: 'App & preferences', description: 'Get whether the app has a valid license (full features). Checks remote login first, then license key.', params: [], returns: 'Promise<{ hasLicense: boolean, source?: "remote"|"key", email?: string }>' },
  { name: 'setLicenseKey', category: 'App & preferences', description: 'Set the license key. Returns updated license status.', params: [{ name: 'key', type: 'string' }], returns: '{ ok: true, hasLicense: boolean }' },
  { name: 'getLicenseServerConfig', category: 'App & preferences', description: 'Get license server config (Laravel Passport): url, clientId, clientSecret.', params: [], returns: '{ url: string, clientId: string, clientSecret: string }' },
  { name: 'setLicenseServerConfig', category: 'App & preferences', description: 'Set license server config for remote login.', params: [{ name: 'config', type: 'object', description: '{ url?, clientId?, clientSecret? }' }], returns: 'null' },
  { name: 'loginToLicenseServer', category: 'App & preferences', description: 'Log in to the license server (Laravel Passport password grant).', params: [{ name: 'email', type: 'string' }, { name: 'password', type: 'string' }], returns: 'Promise<{ ok: boolean, error?: string }>' },
  { name: 'logoutFromLicenseServer', category: 'App & preferences', description: 'Log out from the license server (clear stored token).', params: [], returns: '{ ok: true }' },
  { name: 'getLicenseRemoteSession', category: 'App & preferences', description: 'Get current remote session (logged in, email).', params: [], returns: 'Promise<{ loggedIn: boolean, email?: string }>' },
