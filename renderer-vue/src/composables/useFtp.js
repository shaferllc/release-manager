 ...
 * Refreshes status on mount; when connected, loads the current path list.
 * @returns {{ status, form, connecting, connectError, currentPath, list, listError, loading, pathParts, sortedList, connect, disconnect, setPath, enterDir, loadList, downloadFile, upload, removeFile }}
 */
