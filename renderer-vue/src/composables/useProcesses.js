...
/**
 * Composable for the Processes tab: config, status, suggested processes,
 * start/stop actions, output expansion, and add process.
 * Call with (getInfo) where getInfo() returns props.info.
 * @returns Refs, computeds, and methods for DetailProcessesCard.
 */
