  ...
  <div class="git-card">
    ...
    <div class="mb-3">
      ...
      <div class="flex gap-2">
        ...
        <Button severity="secondary" size="small" class="text-xs text-rm-warning" @click="compare.reset">Reset</Button>
      </div>
    </div>
    <p v-if="compare.error" class="m-0 text-xs text-rm-warning">{{ compare.error }}</p>
  </div>
</template>
...
import { useCompareReset } from '../../../composables/useCompareReset';
