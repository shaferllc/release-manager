  ...
  <div class="git-card bisect-card">
    ...
    <template v-if="bisect.status.active">
      ...
      <div class="flex flex-wrap gap-2 mb-2">
        ...
        <Button severity="secondary" size="small" class="text-xs text-rm-warning hover:bg-rm-warning/10" @click="bisect.markBad">Bad</Button>
    ...
    <p v-if="bisect.error" class="m-0 mt-2 text-xs text-rm-warning">{{ bisect.error }}</p>
  </div>
</template>
...
import { useBisect } from '../../../composables/useBisect';
