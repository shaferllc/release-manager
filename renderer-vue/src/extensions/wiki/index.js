...
import DetailWikiCard from './DetailWikiCard.vue';
...
registerDetailTabExtension({
  id: 'wiki',
  label: 'Wiki',
  description: 'Per-project knowledge base: site URLs, passwords, and notes in one place.',
  version: '1.0.0',
  icon: WIKI_ICON,
  component: DetailWikiCard,
});
